  ...
  return (
    <div style={{ width: '100%', height: '100vh', background: ARK_TOKENS.bg, display: 'flex', flexDirection: 'column' }}>
        ...
        rightActions={
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <div style={{ display: 'flex', gap: 0, border: `1px solid ${ARK_TOKENS.borderStrong}`, borderRadius: ARK_TOKENS.r, overflow: 'hidden' }}>
              <button style={{ padding: '5px 10px', background: ARK_TOKENS.azureLight, color: ARK_TOKENS.azure, border: 'none', fontSize: ARK_TOKENS.type.label, fontWeight: ARK_TOKENS.weight.semibold, cursor: 'pointer' }}>Canvas</button>
              <button style={{ padding: '5px 10px', background: '#fff', color: ARK_TOKENS.inkMuted, border: 'none', borderLeft: `1px solid ${ARK_TOKENS.borderStrong}`, fontSize: ARK_TOKENS.type.label, fontWeight: ARK_TOKENS.weight.medium, cursor: 'pointer' }}>Document</button>
            </div>
      ...
      <div style={{ padding: '16px 24px', borderBottom: `1px solid ${ARK_TOKENS.border}`, background: ARK_TOKENS.surface, display: 'flex', alignItems: 'center', gap: 12 }}>
        <div style={{ flex: 1 }}>
          <h2 style={{ fontSize: ARK_TOKENS.type.h1, fontWeight: ARK_TOKENS.weight.semibold, margin: 0, letterSpacing: -0.2, lineHeight: ARK_TOKENS.leading.tight }}>Auto-retry failed Pro subscription renewals</h2>
          <div style={{ fontSize: ARK_TOKENS.type.label, color: ARK_TOKENS.inkMuted, marginTop: 2, display: 'flex', gap: 10 }}>
            <span>7 cards</span>
            <span>&middot;</span>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'center', margin: '32px 0 20px', gap: 12, alignItems: 'center' }}>
          ...
          <div style={{ fontSize: ARK_TOKENS.type.micro, fontWeight: ARK_TOKENS.weight.semibold, color: ARK_TOKENS.inkMuted, letterSpacing: 0.8, padding: '4px 12px', background: ARK_TOKENS.surfaceAlt, borderRadius: 12 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 24 }}>
          <button
            style={{
              ...
              display: 'flex', alignItems: 'center', gap: 6, fontFamily: 'inherit', fontSize: ARK_TOKENS.type.body,
            }}
          >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8, color: ARK_TOKENS.ai, fontSize: ARK_TOKENS.type.micro, fontWeight: ARK_TOKENS.weight.bold, letterSpacing: 0.5 }}>
            <Ico.sparkle size={12} /> COACH NOTE
          </div>
          <div style={{ fontSize: ARK_TOKENS.type.body, lineHeight: ARK_TOKENS.leading.normal, color: ARK_TOKENS.ink }}>
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: ARK_TOKENS.type.micro, fontWeight: ARK_TOKENS.weight.semibold, color: ARK_TOKENS.inkSubtle, letterSpacing: 0.5, textTransform: 'uppercase' }}>{data.sub}</div>
          <div style={{ fontSize: ARK_TOKENS.type.h2, fontWeight: ARK_TOKENS.weight.semibold, marginTop: 1 }}>{data.title}</div>
        </div>
      </div>
      <div style={{ fontSize: ARK_TOKENS.type.body, lineHeight: ARK_TOKENS.leading.normal, color: ARK_TOKENS.ink, flex: 1 }}>{data.content}</div>
      <div style={{ display: 'flex', gap: 4, marginTop: 4, borderTop: `1px solid ${ARK_TOKENS.border}`, paddingTop: 8 }}>
        <button style={{ border: 'none', background: 'transparent', color: ARK_TOKENS.inkSubtle, cursor: 'pointer', padding: 4, borderRadius: 3, fontSize: ARK_TOKENS.type.label, display: 'flex', alignItems: 'center', gap: 3, fontFamily: 'inherit' }}>
          <Ico.edit size={11} /> Edit
        </button>
        <button style={{ border: 'none', background: 'transparent', color: ARK_TOKENS.ai, cursor: 'pointer', padding: 4, borderRadius: 3, fontSize: ARK_TOKENS.type.label, display: 'flex', alignItems: 'center', gap: 3, fontFamily: 'inherit' }}>
...
function LegendTag({ color, label }: { color: string; label: string }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: ARK_TOKENS.type.label, color: ARK_TOKENS.inkMuted }}>
